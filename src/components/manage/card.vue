  ...
  <div>
    ...
    <el-card class="box-card clearfix" shadow="never">
      ...
      <el-table ref="multipleTable" :data="curTableData" border :default-sort="{prop: 'exceed_time', order: 'descending'}" size="mini">
        ...
        <el-table-column show-overflow-tooltip label="当月用量" show-overflow-tooltip min-width="95" sortable>
          <template slot-scope="scope">
            <div v-html="formatFlowUnit(scope.row.m_use)"></div>
          </template>
        </el-table-column>
        <el-table-column show-overflow-tooltip label="累计用量" show-overflow-tooltip min-width="95" sortable>
          <template slot-scope="scope">
            <div v-html="formatFlowUnit(scope.row.total_use)"></div>
          </template>
        </el-table-column>
        <el-table-column show-overflow-tooltip label="剩余用量" show-overflow-tooltip min-width="95" sortable>
          <template slot-scope="scope">
            <div v-html="formatFlowUnit(scope.row.left_use)"></div>
          </template>
        </el-table-column>
        <el-table-column show-overflow-tooltip prop="excard_time" label="导卡时间" show-overflow-tooltip min-width="155" sortable></el-table-column>
        <el-table-column show-overflow-tooltip prop="active_time" label="激活时间" show-overflow-tooltip min-width="155" sortable></el-table-column>
        <el-table-column show-overflow-tooltip prop="eq_time" label="设备更新时间" show-overflow-tooltip min-width="155" sortable></el-table-column>
        ...
        <el-table-column show-overflow-tooltip prop="op_status" label="运行状态" show-overflow-tooltip min-width="80"></el-table-column>
        <el-table-column show-overflow-tooltip prop="active_status" label="激活状态" show-overflow-tooltip min-width="80"></el-table-column>
