...
public class CasClientConfig {
	 ...
	 */
	@Bean
	public FilterRegistrationBean<H5LoginUserAdapterFilter> assertionThreadLocalFilter(SpringCasProperties springCasProperties, ICcUserService iCcUserService) {
		...
		filter.setiCcUserService(iCcUserService);
