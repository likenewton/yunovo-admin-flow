...
public interface ICcStatsMonthMapper extends BaseMapper<CcStatsMonth> {
	...
	public List<CcStatsMonth> queryItemsPageExport(@Param("org_id")Integer org_id, @Param("card_type")Integer card_type, @Param("card_iccid")String card_iccid, @Param("mdate")String mdate, @Param("orgpos")String orgpos, @Param("orgs")String[] orgs);
